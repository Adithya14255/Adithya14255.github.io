...
const Index = () => {
  ...
  const fullText = "Full Stack Developer & Digital Innovator";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl leading-relaxed">
                Passionate Computer Science student from Coimbatore, Tamil Nadu, crafting innovative 
                digital solutions and contributing to the tech community with modern development practices.
              </p>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-8">
                ...
                <Button size="lg" variant="outline" className="border-primary/50 text-primary hover:bg-primary/10 hover:shadow-glow">
            ...
            <div className="flex justify-center animate-float">
              <div className="relative">
                <div className="w-80 h-80 rounded-full overflow-hidden border-2 border-primary/30 shadow-elegant">
                  <img 
                    src={heroPortrait} 
                ...
                <div className="absolute -bottom-4 -right-4 bg-primary rounded-full p-4 border-2 border-border">
